...
set "OMEGGA_BMF_SOCKET_ENABLED=1"
set "OMEGGA_BMF_SOCKET_POLL_MS=200"
set "BMF_TREECUT_NATIVE_ENABLED=1"
set "BMF_TREECUT_TARGET_AUTO_REFRESH=0"
set "BMF_TREECUT_TARGET_REFRESH_ENABLED=0"
set "BMF_TREECUT_TARGET_REFRESH_DELAY_MS=3000"
set "BMF_BRICK_RUNTIME_SET_ENABLED=1"
set "BMF_BRICK_RUNTIME_CONTEXT_HOOK_ENABLED=1"
set "BMF_BRICK_RUNTIME_PLACE_CONTEXT_HOOK_ENABLED=1"
set "BMF_BRICK_RUNTIME_LOW_SETTER_HOOK_ENABLED=1"
set "BMF_BRICK_RUNTIME_CONTEXT_OVERRIDE_ENABLED=1"
set "BMF_BRICK_OWNER_CONTEXT_SCAN_ENABLED=1"
set "BMF_BRICK_CONTEXT_BACKGROUND_SCAN_ENABLED=1"
set "BMF_BRICK_VISIBILITY_SET_ENABLED=1"
set "BMF_BRICK_VISIBILITY_DIRECT_WRITE_ENABLED=0"
set "BMF_BRICK_COLLISION_SET_ENABLED=1"
set "BMF_BRICK_COLLISION_DIRECT_WRITE_ENABLED=0"
set "BMF_TREE_PHYSICAL_SET_ENABLED=0"
set "CITYRPG_TREE_PHYSICAL_STATE=1"
set "CITYRPG_TREE_PHYSICAL_COLLISION=1"
set "CITYRPG_NATIVE_TREE_REQUIRE_TAG=1"
set "CITYRPG_NATIVE_TREE_IMPACT_ANCHORS=0"
set "CITYRPG_TREE_RUNTIME_WORLD_EDIT=0"
set "CITYRPG_TREE_TAG_INDEX_ON_HIT=0"
set "CITYRPG_TREE_TAG_INDEX_STARTUP=1"
set "CITYRPG_TREE_TAG_INDEX_FILE=%SCRIPT_DIR%artifacts\tree-tag-index.json"
...
set "UE4SS_ACTIVE_MODS=%APPDATA%\omegga\steam_installs\main\Brickadia\Binaries\Win64\ue4ss\main\Mods"
if exist "%SCRIPT_DIR%..\bmf\framework\ue4ss\Mods\BMF\Scripts\main.lua" (
  echo Repairing active BMF UE4SS payload...
  xcopy /E /I /Y "%SCRIPT_DIR%..\bmf\framework\ue4ss\Mods\BMF" "%UE4SS_ACTIVE_MODS%\BMF" >nul
  xcopy /E /I /Y "%SCRIPT_DIR%..\bmf\framework\ue4ss\Mods\BMFSocket" "%UE4SS_ACTIVE_MODS%\BMFSocket" >nul
)
